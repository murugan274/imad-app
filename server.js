...
function hash(input, salt)
{
    ...
    var hashhad = crypto.pbkdf2Sync(input, salt, 10000, 512, 'sha512');
    return hashhad.toString('hex');
}


app.get('/hash/:input', function (req, res) {
    var hashtostring = hash(res.params.input, 'this is some random string');
    res.send(hashtostring);
